...
export const CART2SAVE_SVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="48" height="48"><defs><linearGradient id="c2sG" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#3B82F6"/><stop offset="1" stop-color="#4338CA"/></linearGradient></defs><path d="M9 15h30a2.5 2.5 0 0 1 2.4 3.2l-3.2 12.6A7 7 0 0 1 31.4 36H16.6a7 7 0 0 1-6.8-5.2L6.6 18.2A2.5 2.5 0 0 1 9 15z" fill="url(#c2sG)"/><path d="M17 15a7 7 0 0 1 14 0" fill="none" stroke="url(#c2sG)" stroke-width="3.4" stroke-linecap="round"/><circle cx="18" cy="41.5" r="2.6" fill="#4338CA"/><circle cx="30" cy="41.5" r="2.6" fill="#4338CA"/><path d="M24 19.5l1.7 4.3 4.3 1.7-4.3 1.7-1.7 4.3-1.7-4.3-4.3-1.7 4.3-1.7z" fill="#fff"/><path d="M40 6l1.5 4 4 1.5-4 1.5-1.5 4-1.5-4-4-1.5 4-1.5z" fill="#10B981"/></svg>`
