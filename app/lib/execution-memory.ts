...
// anymore.
//
// Lives in app/lib/ (not the top-level lib/) because that's where
// control-plane.ts already lives, and every '../../../lib/execution-memory'
// import from app/api/founder/*/route.ts resolves here, not to top-level lib/.
