...
export const metadata: Metadata = {
  ...
  // NOTE: no `icons` key here on purpose. The full icon set (favicon.ico plus
  // the square PNGs generated by scripts/generate-icons.mjs) is declared once
  // in app/layout.tsx. Re-declaring icons in this layout overrides that whole
  // set for every public page — which is how the favicon previously ended up
  // pointing at a single non-square image that Google refused to render.
