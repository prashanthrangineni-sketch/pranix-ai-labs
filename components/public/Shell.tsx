...
// Transparent square mark generated by scripts/generate-icons.mjs.
//
// Do NOT swap this for /logo.png or /icon.png:
//   /logo.png  has a white plate baked into the pixels (corners sample as
//              rgb(250,250,250)) and is 682x1024, so it also needs cropping.
//   /icon.png  is rendered by app/icon.png/route.tsx with background
//              '#F9F9FA' — also a white plate.
// Either one puts the white box back behind the header logo.
    ...
    <div className={`pxp ${fontClass ?? ''}`} data-px-theme={theme}>
      ...
      <footer className="pxfooter">
        <div className="wrap">
          <div className="fgrid">
            <div>
              <Link className="logo" href="/"><BrandMark /> Pranix AI Labs</Link>
